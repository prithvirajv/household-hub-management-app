...
function accountBalance(accountId, { accounts, transactions, paychecks, transfers }) {
...
function accountsWithBalances(state) {
  ...
  return accounts.map((account) => ({ ...account, balance: accountBalance(account.id, context) }));
}
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = {
    ...
    accountBalance, accountsWithBalances
  };
}
