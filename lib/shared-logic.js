...
// that was already accepted into the ledger) reproduces the exact same
// date/amount/payee. Flag those matches so the household can see it before
// approving, rather than silently double-counting the spend.
