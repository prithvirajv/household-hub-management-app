...
function paycheckOccurrenceDatesInRange(paycheck, rangeStartKey, rangeEndKey) {
  ...
  if (recurrence === "once" || recurrence === "bonus") {
    return (paycheck.date >= rangeStartKey && paycheck.date <= rangeEndKey) ? [paycheck.date] : [];
  }
  const anchor = parseDateKey(paycheck.date);
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = {
    ...
    paycheckOccurrencesSince, paycheckOccurrencesInRange, paycheckOccurrenceDatesInRange, recurringExpenseOccurrenceDates, accountBalance, accountsWithBalances,
