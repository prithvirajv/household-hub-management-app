...
// description onto its own line before the Type/Amount columns reach it, so
// records are recovered by scanning the whole (noise-stripped) text for
// "date-or-Processing ... Type Amount Balance" rather than assuming one
// record per source line.
